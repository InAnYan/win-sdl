...
#define BUTTON_UND_REGION {bounds.x + bounds.w-5 - WINDOW_TITLE_HEIGHT  -WINDOW_BUTTON_WIDTH - WINDOW_TBUTTONS_SPACE -WINDOW_BUTTON_WIDTH-1, bounds.y+6, WINDOW_BUTTON_WIDTH, WINDOW_TITLE_HEIGHT-4}
